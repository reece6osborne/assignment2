<?php
    ...
    if ($user != "" && $pass != "")
    {
        $conn = @mysql_connect ("mysql.hostinger.co.uk", "u696084782_admin", "multiuser1") or die ("Sorry - unable to connect to MySQL database.");
        $rs = @mysql_select_db ("u696084782_admin", $conn) or die ("error");
